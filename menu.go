...
func (m *menu) Initialize() error {
	entities := []system.SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: "13", Path: "project", Name: "project", Component: "view/project/project/project.vue", Sort: 1, Meta: system.Meta{Title: "项目管理", Icon: "operation", KeepAlive: true}},
		...
		{MenuLevel: 0, Hidden: false, ParentId: "13", Path: "target_relation", Name: "target_relation", Component: "view/project/target_relation/target_relation.vue", Sort: 1, Meta: system.Meta{Title: "no_display", Icon: "operation", KeepAlive: true}},
		...
		{MenuLevel: 0, Hidden: false, ParentId: "14", Path: "poc_manager", Name: "poc_manager", Component: "view/poc_manager/poc_manager/poc_manager.vue", Sort: 1, Meta: system.Meta{Title: "POC管理", Icon: "operation", KeepAlive: true}},
	}

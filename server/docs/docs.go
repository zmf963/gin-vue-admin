    ...
    "paths": {
        ...
        "/email/getEmailList": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "分页获取Email列表",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.EmailSearch"
                        }
                    }
                ],
                "responses": {
        ...
        "/poc_manager/createPocManager": {
            "post": {
                ...
                "summary": "创建PocManager",
                "parameters": [
                    {
                        "description": "创建PocManager",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/poc_manager.PocManager"
                        }
                    }
                ],
                "responses": {
        ...
        "/poc_manager/deletePocManager": {
            "delete": {
                ...
                "summary": "删除PocManager",
                "parameters": [
                    {
                        "description": "删除PocManager",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/poc_manager/deletePocManagerByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "summary": "批量删除PocManager",
                "parameters": [
                    {
                        "description": "批量删除PocManager",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/poc_manager/findPocManager": {
            "get": {
                ...
                "summary": "用id查询PocManager",
                "parameters": [
                    {
                        "type": "string",
                        "description": "用id查询PocManager",
                        "name": "data",
                        "in": "query",
                        "required": true
                    }
        ...
        "/poc_manager/getPocManagerList": {
            "post": {
                ...
                "summary": "分页获取PocManager列表",
                "parameters": [
                    {
                        "description": "分页获取PocManager列表",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.PocManagerSearch"
                        }
                    }
                ],
                "responses": {
        ...
        "/poc_manager/updatePocManager": {
            "put": {
                ...
                "summary": "更新PocManager",
                "parameters": [
                    {
                        "description": "更新PocManager",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
